...
class CV_App(QMainWindow):
    ...
    def refresh_img(self):
        pixmap = QPixmap("grayscale_image1.jpg" )
    ...
    def browse_img(self):
        ...
        if filename:
            ...
            if not pixmap.isNull():
                ...
                cv2.imwrite("grayscale_image1.jpg" , self.gray_img)
                pixmap = QPixmap("grayscale_image1.jpg" )
                self.ui.filter_outputImage.setPixmap(pixmap)
                self.ui.Threshold_outputImage.setPixmap(pixmap)
                self.ui.EdgeDetection_outputImage.setPixmap(pixmap)
    ...
    def browse_input_image2(self):
        ...
        if filename:
            ...
            if not pixmap.isNull():
                ...
                cv2.imwrite("grayscale_image2.jpg" , self.gray_img2)
                pixmap = QPixmap("grayscale_image2.jpg" )
